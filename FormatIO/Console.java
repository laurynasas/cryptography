...
protected	int	get_char()	throws EofX { return con.get_char(); }
	}
...
public	char	readChar()
	{ try { return cin.readChar(); } catch (EofX x) {} return '?'; }
public	String	readLine()
	{ try { return cin.readLine(); } catch (EofX x) {} return "?"; }
public	String	readWord()
	{ try { return cin.readWord(); } catch (EofX x) {} return "?"; }

public	char	getChar()
	{ try { return cin.getChar(); } catch (EofX x) {} return '?'; }
public	String	getLine()
	{ try { return cin.getLine(); } catch (EofX x) {} return "?"; }

public	void	skipLine()
	{ try { cin.skipLine(); } catch (EofX x) {} }
public	boolean	eof()
	{ return cin.eof(); }
